...
class NightAzkar extends StatefulWidget {
  ...
  NightAzkar({required this.selectedDate});

  @override
  _NightAzkarState createState() => _NightAzkarState();
}

class _NightAzkarState extends State<NightAzkar> {
  ...
  Future<void> _loadCounters(DateTime selectedDate) async {
    ...
    azkar.forEach((key, value) {
      String dateKey =
          'night_${selectedDate.year}-${selectedDate.month}-${selectedDate.day}_$key';
  ...
  Future<void> _saveCounter(String key, int value) async {
    String dateKey =
        'night_${widget.selectedDate.year}-${widget.selectedDate.month}-${widget.selectedDate.day}_$key';
